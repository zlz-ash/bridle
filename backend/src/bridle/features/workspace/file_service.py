...
from bridle.features.workspace.schemas import WorkspaceFileReadResponse
...
class WorkspaceFileService:
    ...
    def read_text(workspace: Path, rel_path: str) -> WorkspaceFileReadResponse:
        """Read one safe workspace text file; workspace/path input exits as bounded UTF-8 content."""
