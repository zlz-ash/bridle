...
def _validate_sentinel_record(value: object, *, field: str) -> dict[str, Any]:
    ...
    canonical_path = _require_nonempty_str(value.get("canonical_path"), field=f"{field}.canonical_path")  # noqa: F841 — validated for side-effect of rejecting empty/missing values
